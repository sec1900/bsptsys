...
def CreateNumberList():
    ...
    itertoolsNumberList = itertools.product(words, repeat=3)  # ('0', '0', '0') 生成3个words的笛卡尔积
...
if __name__ == '__main__':
    ...
    parser.add_argument("-ymd", "--ymd")
    parser.add_argument("-y", "--year")
    parser.add_argument("-md", "--md")
    parser.add_argument("-qq", "--qq")
    ...
    global infolist
    infolist = []
    infolist.append(args.Name)
    infolist.append(args.name)
    infolist.append(args.phone)
    infolist.append(args.Name)
    infolist.append(args.ymd)
    infolist.append(args.Name)
    infolist.append(args.year)
    infolist.append(args.md)
    infolist.append(args.qq)
    # 数字列表
    global numberList
    numberList = []
    # 特殊字符列表
